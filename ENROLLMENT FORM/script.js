...
const getData = function () {
  ...
  return { name, email, website, image, phoneno, dept, gender, skills };
};
...
function printResult(data) {
  ...
  dept.className = "infoText dept";
  dept.innerHTML = data.dept;

  let userImage = document.createElement('img');
  userImage.className = "userImage";
  userImage.src = data.image;

  textInfoContainer.append(name, gender, email, website, phoneno, dept, skills);
